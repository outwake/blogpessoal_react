...
//Estado para armazenar os dados do usuario
...
//Função de atualização de estados usuario
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
      ...
      onSubmit={cadastrarNovoUsuario}>
        ...
        <div className="flex justify-around w-full gap-8">
          ...
          <button type="submit" className="rounded text-white bg-red-400 hover: bg-indigo-900 w-1/2 py-2">
          {
								isLoading ?
